...
public class SchoolDaoImpl implements SchoolDao {
    ...
    * Do not change any code outside of the placeholders provided.
    ...
    public List<TeacherCount> teacherCountByDept() {
        ...
        String sql = "SELECT dept, COUNT(*) teacherCount FROM teacher GROUP BY dept";
    ...
    public List<StudentClassCount> studentsPerClass() {
        ...
        String sql = "SELECT courseCode, courseDesc, COUNT(*) numStudents FROM course JOIN course_student ON course.cid = course_student.course_id  GROUP BY courseCode";
    ...
    public void deleteTeacher() {
        ...
        //where fName = 'David' AND lName = 'Mitchell'
